...
\titlerunning{Tangent-stiffness matrices in parallel computational peridynamics code}
...
\keywords{Newton's method \and Newton-Raphson \and numeric differentiation \and complex-step \and finite-difference \and automatic-differentiation \and Jacobian matrix \and tangent-stiffness}
\subclass{MSC 65D25}
\end{abstract}
