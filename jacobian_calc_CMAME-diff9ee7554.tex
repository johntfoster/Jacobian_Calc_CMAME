...
%DIF DEL jacobian_calc_CMAME-oldtmp-59275.tex   Thu Apr 24 23:11:28 2014
%DIF ADD jacobian_calc_CMAME.tex                Thu Apr 24 23:11:19 2014
%DIF < %%
...
\section{Introduction\DIFaddbegin \DIFadd{.}\DIFaddend }
...
\DIFaddbegin \section{\todo[]{Re: I.5}\DIFadd{Simple example of CS, AD and FD for solution of nonlinear problems.}}
...
\end{figure}
%DIF > 
\DIFadd{For this system, the equilibrium reaction force associated with a displacement $D$ of the spring is shown in equation~(\ref{eqn:TrussForce}) 
%DIF > 
}\begin{equation} 
...
\DIFaddend \section{Description of analysis tools and approach.} 
%
\subsection{\DIFdelbegin \emph{\DIFdel{Peridigm}} %DIFAUXCMD
\DIFdelend \DIFaddbegin \DIFadd{Peridigm }\DIFaddend and peridynamics.}
\DIFaddbegin \label{subsec:PaP}
\DIFaddend %
Comparisons of the different tangent-stiffness \DIFaddbegin \DIFadd{matrix }\DIFaddend calculation techniques were carried out through code-development and \DIFdelbegin \emph{\DIFdel{in situ}} %DIFAUXCMD
