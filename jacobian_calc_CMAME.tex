...
of the body show that numbering is not contiguous and is assigned with respect to four regions,
called \emph{material blocks} in \emph{Peridigm}. The purpose of designating
these material blocks, for this study, is to register the blocks on the ends of
the mesh as volumetric regions over which to apply displacement boundary
...
\begin{table*}[!ht]    
  ...
  \centering
       ...
       \begin{tabular}{c c c c c c c}
         \toprule
         Peri. nodes & Nozero TS elems. & Nonzero Fraction & Horizon & Load rate & # Load steps & Abs. tolerance \\ 
