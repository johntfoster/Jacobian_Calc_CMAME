...
defined by comparison of the \note[Michael]{re: I.1}\remove[Michael]{new}
...
\begin{table*}[!ht]    
  ...
  \centering
       ...
       \begin{tabular}{c c c c c c}
        ...
        \midrule
        1000 & 1.99             & .3   & 2.0 & 2 & 10^-8\\
        2000 & 4.25             & .24  & 2.0 & 2 & 10^-8\\
        3000 & 7.79             & .21  & 2.0 & 2 & 10^-8\\
        4000 & 15.4             & .19  & 2.0 & 2 & 10^-8\\
        6000 & 20.0             & .16  & 2.0 & 2 & 10^-8\\
        8000 & 31.4             & .15  & 2.0 & 2 & 10^-8\\
        12000 & 40.1            & .131 & 2.0 & 2 & 10^-8\\
        16000 & 83.9            & .12  & 2.0 & 2 & 10^-8\\
        32000 & 165.0           & .095 & 2.0 & 2 & 10^-8\\
        1000000 & 1670          & .03  & 2.0 & 2 & 10^-8\\
        \bottomrule
    \end{tabular}
\end{table*}
...
\label{sec:Res}
%
Table~\ref{tab:results} shows the compute core count, number of nonzero tangent-stiffness (TS) non-zero matrix elements, load step average calculation time and load step average accuracy. The units for accuracy are derived Eqn.~(\ref{eqn:accuracy}) and the units used to define bulk material properties, mentioned in Section~\ref{tcs}.
%
\begin{table*}[!ht]    
  \scriptsize
  \centering
...
this suggests that the methods as in \emph{Peridigm} have the same order
algorithm complexity when considering computing a TS matrix alone, that is
computation time is $\mathcal{O}(10^{(10^{-6} \times \log_{10}n)})$. This would
suggest, to the algorithm design way of thinking, that the methods are equally
well suited to the task of computing a TS matrix, if it were further assumed
...
\begin{table*}[!ht]    
  ...
  \centering
       ...
       \begin{tabular}{c c c c c}
         ...
         & $\times 10^6$ & CD & CS & FD \\
        \midrule
        1 & $1.99$  & 1.28x10^-8 & 2.29x10^-15 & 1.46x10^-5\\
        1 & $4.25$  & 8.86x10^-8 & 2.25x10^-14 & 1.34x10^-5\\
        1 & $7.79$  & 1.37x10^-8 & 2.27x10^-14 & 1.25x10^-5\\
        1 & $15.4$  & 4.33x10^-8 & 2.52x10^-14 & 1.16x10^-5\\
        1 & $20.0$  & 7.97x10^-8 & 2.18x10^-15 & 1.13x10^-5\\
        1 & $31.4$  & 1.44x10^-8 & 2.29x10^-15 & 1.09x10^-5\\
        1 & $40.1$  & 1.36x10^-7 & 2.24x10^-15 & 1.05x10^-5\\
        1 & $83.9$  & 1.30x10^-7 & 2.44x10^-14 & 9.63x10^-6\\
        1 & $165.0$  &1.30x10^-7 & 2.44x10^-14 & 9.63x10^-6\\
        32 & $1670$  &6.00x10^-7 & 2.29x10^-14 & 6.93x10^-6\\
        64 & $1670$  & 6.01x10^-7 & 2.31x10^-14 & 7.02x10^-6\\
        96 & $1670$  & 6.03x10^-7 & 2.33x10^-14 & 7.10x10^-6\\
        128 & $1670$  & 5.97x10^-7 & 2.34x10^-14 & 7.19x10^-6\\
        \bottomrule
    \end{tabular}
\end{table*}
