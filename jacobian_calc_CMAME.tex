...
an series form and the computing of analytical derivatives is shown. This prior
...
the global residual, for FEM simulations using the MRS-Lade material model
...
AD is mathematically equivalent to first order CS. The instant work is novel with respect to the prior
work because the instant work investigates CS as applied to a numerical method
for solving non-linear systems, rather than as in the prior work investigating
...
order accurate derivatives with CS and choosing optimal step size.  The instant
work discusses using the derivatives computed with the CS method in a numerical
...
prior work the derivatives produced by CS themselves are the object of
...
the instant work, discusses the background of the CS method and frames it as a subset
...
by a matrix representation of complex numbers during computations, yet without storing
...
With respect to the prior work discussing the CS method, the primary novel
